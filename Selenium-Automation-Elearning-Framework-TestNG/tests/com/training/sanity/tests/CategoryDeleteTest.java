...
public class CategoryDeleteTest {
	...
	private CategoryDeletePOM categoryDeletePOM;
	...
	public void setUp() throws Exception {
		...
		categoryDeletePOM = new CategoryDeletePOM(driver);
	...
	public void deleteCategoryTest() throws InterruptedException{
		...
		//String S=driver.findElement(By.xpath("//table/tbody/tr[2]/td[1]")).getAttribute("value");
		//System.out.println(S);
		Thread.sleep(5000);
		categoryDeletePOM.deleteCategory();
		...
		alert.accept();
		String message2=categoryDeletePOM.validateSuccessMessage();
		System.out.println(message2);
		String expected2="Success: You have modified categories!";
		assertTrue(message2.contains(expected2));
		screenShot.captureScreenShot("CategoryDelete");
